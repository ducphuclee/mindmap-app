---
name: write-prd
description: Turn the current conversation context into a PRD and publish it to Venus as a plan document. Use when user wants to create a PRD from the current context.
---
