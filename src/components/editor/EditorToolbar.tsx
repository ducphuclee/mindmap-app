  ...
  return (
    <div className="relative flex items-center gap-1 border-b border-gray-200 bg-white px-4 py-1">
      ...
      <button
        ...
        onClick={onFitView}
        title="Fit to screen"
        className="flex items-center gap-1.5 rounded-[4px] px-3 py-1.5 text-xs text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900"
      >
        <svg
          className="h-4 w-4"
          fill="none"
      ...
      <button
        ...
        className="flex items-center gap-1.5 rounded px-3 py-1.5 text-xs text-gray-300 disabled:cursor-not-allowed"
      >
        <svg
          className="h-4 w-4"
          fill="none"
